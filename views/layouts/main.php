<?php
// Pick correct asset base depending on Render vs local dev.
// Render sets the RENDER environment variable; if present, serve assets from root /assets
...
<body class="bg-white">
    <!-- Your beautiful header (keep the HTML structure the same) -->
    <header class="bg-white border-b border-gray-200 z-10">
        <!-- Top Bar: Delivery and Customs Info -->
